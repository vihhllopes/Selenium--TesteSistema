...
// PAGINA DA IMPERIO
  ...
  //Teste da Falso porque o nome do site nao esta correto
  //FALSE
  @Test
  public void UrlSiteFalse() {
    webdriver.get("https://www.lojasimperio.com.br/");
    Boolean verifyTitle = webdriver.getTitle().equalsIgnoreCase("imperio moveis");
    Assertions.assertFalse(verifyTitle);
  }
  //TRUE
  @Test
  public void UrlSiteTrue() {
    webdriver.get("https://www.lojasimperio.com.br/");
    Boolean verifyTitle = webdriver.getTitle().equalsIgnoreCase("Império Móveis e Eletro");
    Assertions.assertTrue(verifyTitle);
  }
